...
export default function Home() {
	return (
		<>
			...
			<motion.div
				className="absolute bg-white dark:bg-gray-800 dark:text-white sm:rounded-lg border dark:border-none bottom-0 sm:left-5 sm:bottom-5 shadow-xl flex flex-col justify-center items-start py-7 sm:py-6 px-7 z-10"
